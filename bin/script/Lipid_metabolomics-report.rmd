---
# title: "脂质代谢组学报告"
# subtitle: 'Lipids Metabolomics Report '
output:
  html_document:
    css: style.css
    toc: yes
...
<div id="header">
  ...
  <h1 class="title toc-ignore">脂质代谢组学报告</h1>
  <h3 class="subtitle">Lipids Metabolomics Report</h3>
...
本项目利用高分辨率质谱仪（Q Exactive(Thermo Fisher Scientific, USA)），采用LC-MS/MS技术对`r sample_num`个`r sample_type`样品分别采集正离子（pos）和负离子（neg）两种模式的数据进行脂质代谢组学检测，探索样品内脂质组成以及生物功能。
